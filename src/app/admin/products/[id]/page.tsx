...
export default function EditProductPage() {
      ...
      .then(([pd, cd]) => {
        if (pd.product) {
          ...
          setForm({
            ...
            top_notes: Array.isArray(p.top_notes) ? p.top_notes.join(", ") : "",
            middle_notes: Array.isArray(p.middle_notes) ? p.middle_notes.join(", ") : "",
            base_notes: Array.isArray(p.base_notes) ? p.base_notes.join(", ") : "",
            ...
            delivery_estimate: p.delivery_estimate ?? "3-5 business days across India",
  ...
  const confirmDelete = async () => {
    setDeleting(true);
    const toastId = toast.loading(`Deleting ${form.name}...`);
  ...
  if (loading) {
    return <div style={{ padding: "3rem", fontFamily: "var(--font-sans)", color: "#999" }}>Loading product details...</div>;
  }
  ...
  if (!form) {
    return (
      <div style={{ padding: "3rem", fontFamily: "var(--font-sans)" }}>
        ...
        <Link href="/admin/products" style={{ color: "#111", textDecoration: "underline", marginTop: "1rem", display: "inline-block" }}>
          Back to Products
        </Link>
      </div>
    );
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        set(
                          "season",
                          selected ? form.season.filter((s: string) => s !== season) : [...form.season, season]
                        );
                      }}
                      style={{
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        set(
                          "occasion",
                          selected ? form.occasion.filter((o: string) => o !== occ) : [...form.occasion, occ]
                        );
                      }}
                      style={{
                        padding: "0.4rem 0.8rem",
        ...
        >
          ...
          >
            ...
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "0.85rem", color: "#555", lineHeight: 1.5, marginBottom: "1.75rem" }}>
              Are you sure you want to permanently remove <strong>{form.name}</strong> from your fragrance catalog and store?
            </p>
