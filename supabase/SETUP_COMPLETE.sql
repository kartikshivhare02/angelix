...
create table if not exists settings (
  ...
  brand_name text default 'ANGELIX',
  brand_subtitle text default 'by Suraj',
  logo_url text,
  favicon_url text,
  instagram_url text default 'https://instagram.com/angelix',
  whatsapp_number text default '+91 70676 97646',
  support_email text default 'Surajxsingh412@gmail.com',
  ...
  footer_tagline text,
  seo_title text default 'ANGELIX by Suraj — Luxury Fragrances',
  seo_description text,
  created_at timestamptz default now(),
  updated_at timestamptz default now()
);
